...
<div class="modal fade" id="secession" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div v-if="test" class="Mypage">
    <div class="mypageNav">
      ...
      <!-- <div v-if="isOwner" class="mypageBtn" style="font-size: 1.3vw; " @click="showUpdateInfo" @mouseover="change4">회원정보수정</div> -->
      <div v-if="isOwner" class="mypageBtn" style="font-size: 1.3vw; margin-top: 13vw;" data-bs-toggle="modal" data-bs-target="#secession" @mouseover="change4">회원탈퇴</div>
    </div>
