...
/* 엽서사전에서 제공하는 서비스 목록 관리(엽서사전에서 가능합니다) */
.mainpageServiceIntro {
  position: relative;
  height: 100vh;
  background-color: #faf8f5;
}

.mainpageServiceIntroContent {
  position: absolute;
  height: 70vh;
  width: 75vw;
  top: 50%;
...
.mainpageServiceIntroContentItem {
  margin-top: 10vh;
  width: 15vw;
  height: 20vh;
  border-radius: 10px;
